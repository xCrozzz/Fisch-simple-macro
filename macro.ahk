...
F1:: {
    if Status == true {
        global Status := false
        Text1.Text := "Status: False, Not On"
        return
    }

    else
        global Status := true
        Text1.Text := "Status: True, On"
        return
}

Shake := A_ScriptDir "\Images\Shake.png"

TextSearch := mygui.AddText("Center", "Waiting For Status")
...
while true {
    if Status{
        ...
        Text:="|<>*118$91."

        if (ok:=FindText(&FoundX, &FoundY, 1047-150000, 271-150000, 1047+150000, 271+150000, 0, 0, Text))
        {
            TextSearch.Text := "Found Target"
            moveToTarget
        }
...
Text:="|<d>*131$71."

if (ok:=FindText(&X, &Y, 1047-150000, 271-150000, 1047+150000, 271+150000, 0, 0, Text))
{
